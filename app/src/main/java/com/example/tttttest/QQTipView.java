...
public class QQTipView extends View {
    ...
    // 存储每个Item的信息
    private List<QQTipItem> mItemList = new ArrayList<>();
    // 存储每个方块
    ...
    public QQTipView(Context context, ViewGroup rootView, int x, int y, List<QQTipItem> mItemList) {
        super(context);
        // 设置传入过来的x轴坐标
        this.x = x;
        // 设置传入过来的y轴坐标
    ...
    public void setTipItemList(final List<QQTipItem> list) {
        mItemList.clear();
        List<QQTipItem> items = list;
        for (QQTipItem item : items) {
    ...
    public static class Builder {
        ...
        private List<QQTipItem> mTipItemList = new ArrayList<>();
        ...
        public Builder addItem(QQTipItem tipItem) {
            mTipItemList.add(tipItem);
            return this;
        }

        public Builder addItems(List<QQTipItem> list) {
        ...
        public QQTipView create() {
            QQTipView flipShare = new QQTipView(mContext, mRootView, x, y, mTipItemList);
